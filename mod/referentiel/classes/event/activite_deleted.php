 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class activite_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventactivitydeleted', 'mod_referentiel');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'referentiel', 'activity deleted', $url, $this->objectid, $this->contextinstanceid);
    }
}

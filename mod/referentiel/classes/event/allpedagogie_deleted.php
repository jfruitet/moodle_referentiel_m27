 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class pedagogie_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventallpedagogydeleted', 'mod_referentiel');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted all the pedagogy for the occurrence of referentiel {$this->objectid} from " .
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'referentiel', "all pedagogies of occurrence {$this->objectid} deleted", $url, $this->contextinstanceid);
    }
}

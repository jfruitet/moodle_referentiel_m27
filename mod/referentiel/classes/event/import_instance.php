...
class course_module_viewed extends \core\event\import_intance {
    ...
    public function get_url() {
        return new \moodle_url('/mod/referentiel/import_intance.php', array('id' => $this->contextinstanceid));
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'referentiel', 'view', 'import_intance.php?id='.$this->contextinstanceid,

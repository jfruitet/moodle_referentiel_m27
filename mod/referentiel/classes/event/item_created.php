...
class item_created extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has created the item {$this->objectid} for the ".
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'referentiel', 'create item', $url, $this->objectid, $this->contextinstanceid);
    }

...
class pedagogie_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpedagogydeleted', 'mod_referentiel');
    }
    ...
    public function get_description() {
        $userdesc = '';
        return "The user with id '$this->userid' deleted the pedagogy {$this->objectid} for the referentiel with " .
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'referentiel', 'pedagogy deleted', $url, $this->objectid, $this->contextinstanceid);
    }
}

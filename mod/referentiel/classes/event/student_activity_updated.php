 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class student_activity_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventstudentactivityupdated', 'mod_referentiel');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has updated their declaration for the ".

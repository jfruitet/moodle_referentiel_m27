 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class task_linked extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventtasklinked', 'mod_referentiel');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has souscripted the task {$this->objectid} for the referentiel with " .
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'referentiel', 'task assigned', $url, $this->objectid, $this->contextinstanceid);
    }
}

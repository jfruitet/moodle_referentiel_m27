...
$plugin->version  = 2014110305;  // The current module version (Date: YYYYMMDDXX)
$plugin->release  = 'Referentiel v 10.05 for Moodle 2.7 and 2.8 with scale support, block and report - Release 2014-11-15';    // User-friendly date of release

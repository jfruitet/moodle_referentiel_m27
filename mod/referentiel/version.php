...
$plugin->version  = 2014110301;  // The current module version (Date: YYYYMMDDXX)
$plugin->release  = 'Referentiel v 10.03 for Moodle 2.7 with scale support, block and report - Release 2014-11-09';    // User-friendly date of release
